...
class PermissionsRegistry:
    ...
    PERMISSIONS_AR_MAP = {
        ...
        SystemPermissions.ACCESS_TENANT_CONSOLE: 'لوحة_مالك_الشركة',
    ...
    PERMISSIONS = {
        ...
        'owner_only': {
            ...
            SystemPermissions.ACCESS_TENANT_CONSOLE: {
                'name_ar': 'لوحة مالك الشركة (تينانت)',
                'code_ar': 'لوحة_مالك_الشركة',
                'description': 'الوصول إلى /t/<slug>/console — شركتك فقط',
                'module': 'owner_only',
                'is_protected': True,
            },
        },
        ...
        'branches': {
            SystemPermissions.MANAGE_BRANCHES: {
                ...
                'description': 'إدارة الفروع والمواقع والشركات',
                'module': 'branches',
                'is_protected': True,
            },
            SystemPermissions.VIEW_ALL_BRANCHES: {
                ...
                'description': 'رؤية بيانات جميع الفروع والشركات داخل التينانت',
                'module': 'branches',
                'is_protected': True,
            },
        },
    ...
    ROLES = {
        ...
        SystemRoles.MANAGER: {
            ...
            'permissions': [
                ...
                SystemPermissions.MANAGE_SALES, SystemPermissions.VIEW_SALES, SystemPermissions.ARCHIVE_SALE,
                SystemPermissions.MANAGE_PAYMENTS, SystemPermissions.VIEW_PAYMENTS, SystemPermissions.MANAGE_EXPENSES,
                ...
                SystemPermissions.MANAGE_BRANCHES, SystemPermissions.VIEW_ALL_BRANCHES,
            ],
            'is_protected': False,
            'is_super': False,
            'level': 3,
